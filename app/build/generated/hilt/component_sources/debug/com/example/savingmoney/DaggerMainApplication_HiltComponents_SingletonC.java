...
import com.example.savingmoney.ui.home.HomeViewModel;
import com.example.savingmoney.ui.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.savingmoney.ui.settings.SettingsViewModel;
import com.example.savingmoney.ui.settings.SettingsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.savingmoney.ui.stats.StatsViewModel;
...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(5).add(AuthViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SettingsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(StatsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(TransactionViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(5).put("com.example.savingmoney.ui.auth.AuthViewModel", ((Provider) authViewModelProvider)).put("com.example.savingmoney.ui.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.example.savingmoney.ui.settings.SettingsViewModel", ((Provider) settingsViewModelProvider)).put("com.example.savingmoney.ui.stats.StatsViewModel", ((Provider) statsViewModelProvider)).put("com.example.savingmoney.ui.transaction.TransactionViewModel", ((Provider) transactionViewModelProvider)).build();
    }
